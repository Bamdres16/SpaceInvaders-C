...
void inicioDelJuego() {
    ...
    mvprintw(altoPantalla/2-3, anchoPantalla/2+29, invasoresCancrejo[0]);
    mvprintw(altoPantalla/2-2, anchoPantalla/2+29, invasoresCancrejo[1]);
    mvprintw(altoPantalla/2-1, anchoPantalla/2+29, invasoresCancrejo[2]);
    mvprintw(altoPantalla/2+1, anchoPantalla/2+28, "Pulpo");
    mvprintw(altoPantalla/2+2, anchoPantalla/2+28, "40 puntos");

    mvprintw(altoPantalla/2-3, anchoPantalla/2-3, invasoresCalamar[0]);
    mvprintw(altoPantalla/2-2, anchoPantalla/2-3, invasoresCalamar[1]);
    mvprintw(altoPantalla/2-1, anchoPantalla/2-3, invasoresCalamar[2]);
    mvprintw(altoPantalla/2+1, anchoPantalla/2-2, "Cangrejo");
    ...
    mvprintw(altoPantalla/2+11, anchoPantalla/2-19, "Brayan Muñoz-Sebastián Alba-Edgar Chaves");
    refresh();
